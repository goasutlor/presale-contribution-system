...
export default function UserForm({ onSubmit, onCancel, initialData, isEditing = false, existingEmails = [] }: UserFormProps) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                {isEditing && <span className="text-gray-500 text-xs"> (เว้นว่างถ้าไม่ต้องการเปลี่ยน)</span>}
              </label>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <input
                      ...
                      placeholder={isEditing ? 'เว้นว่างถ้าไม่ต้องการเปลี่ยน' : 'รหัสผ่าน'}
